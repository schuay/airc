...
_LAZY = {
    ...
    "MAX_TOOL_RESULT_CHARS": ".mcptools",
    "MCPToolset": ".mcptools",
    "ModelProfile": ".config",
    "REFUSAL_STOP_REASON": ".providers",
    "RequireStructuredResultMiddleware": ".agent",
    "STOP_REASON_KEYS": ".providers",
    "SUPPORTED_PROVIDERS": ".model",
    "StructuredTaskError": ".structured",
    "StructuredTaskRunner": ".structured",
    "TimeBudgetMiddleware": ".agent",
    "TokenLog": ".tokens",
    "ToolBuildContext": ".toolgrants",
    "ToolCatalog": ".toolgrants",
    "ToolGrant": ".toolgrants",
    "ToolSource": ".toolgrants",
    "ToolSpec": ".toolgrants",
    "Usage": ".usage",
